...
description: 사용자가 버그, 불명확한 증상, 스크린샷, 로그, 단순 디버깅 요청을 전달할 때 사용합니다. 먼저 tmp/에 버그 리포트를 만들고, 재현 정보나 원인 축소 행동을 요청하며, 사용자가 명시적으로 수정/디버깅 시작을 요청한 뒤에만 코드 수정을 시작합니다.
---
...
```text
tmp/YYYYMMDD-HHMM-bug-<topic>-workflow.md
```
